...
im = imread('E:\Documentos\ING_BIOMEDICA\Cuarto Año\Segundo Cuatrimestre\Procesamiento Digital de Imágenes\TP_Final\Imagenes\005source.jpg');
...
[im_APE_ind,im_APE_peg] = individuales(APE(:,1:2),im_APE);
...
%% Postprocesado
[APE_sep, im_APE_sep] = separar(im_APE_peg, im);
im_APE_sep = relabel(im_APE_sep, tam);
